...
<head>
    ...
    <style>
        ...
        body {
            ...
            background-image: url('https://res.cloudinary.com/dbleggv6z/image/upload/v1728223259/RevShop/b4_ooppt8.jpg');
...
<body class="bg-gray-100 flex justify-center items-center h-screen">
    <div class="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
        ...
        <form action="${pageContext.request.contextPath}/SellerController" method="post">
            ...
            <div class="mb-4">
                <label for="business_name" class="block text-gray-600 font-semibold mb-2">Business Name:</label>
                <input type="text" id="business_name" name="business_name" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-400" required>
            </div>
            ...
            <div class="flex justify-center">
                <input type="submit" value="Register" class="bg-indigo-500 text-white font-semibold py-2 px-6 rounded-md hover:bg-indigo-600 cursor-pointer">
            </div>
		    ...
		    >
		      ...
		      <a
		        ...
		        href="${pageContext.request.contextPath}/views/seller/login.jsp"
		      >
		        Login
		      </a>
		    </p>
