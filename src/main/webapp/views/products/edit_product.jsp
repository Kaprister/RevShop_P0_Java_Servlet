...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="flex justify-center items-center p-4">
        <div class="form-container bg-white bg-opacity-10 p-8 rounded-lg shadow-lg w-full max-w-lg fade-in">
            <h1 class="text-2xl font-bold text-center text-white mb-6">Edit Product</h1>

            <form action="${pageContext.request.contextPath}/ProductController?action=updateProduct" method="post" class="space-y-6">
                ...
                <div class="relative">
                    ...
                    <textarea id="description" name="description" rows="4"
                              class="mt-1 block w-full px-4 py-3 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 transition duration-200 ease-in-out transform hover:scale-105">${product.description}</textarea>
                </div>
                ...
                <div class="relative">
                    ...
                    <input type="number" id="rating" name="rating" value="${product.rating}" required
                           class="mt-1 block w-full px-4 py-3 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 transition duration-200 ease-in-out transform hover:scale-105">
                </div>

                <div>
                    <input type="submit" value="Update Product"
                           class=" pointer w-full py-3 px-6 bg-indigo-600 text-white font-bold rounded-md shadow-sm transition duration-300 transform hover:scale-105 btn-hover">
                </div>
            </form>

            <a href="${pageContext.request.contextPath}/ProductController?action=viewProducts" 
               class=" pointer block text-center text-indigo-600 mt-6 hover:text-indigo-800 transition duration-300 transform hover:translate-y-1">
                View all products
            </a>
        </div>
    </div>
